...
class NewVC: UIViewController,UITableViewDelegate,UITableViewDataSource,UICollectionViewDelegate,UICollectionViewDataSource{
...
//    Button Actions
    ...
    func tableviewSetup(){
        ...
        mTableView.register(UINib(nibName:"NextCell" , bundle: Bundle.main), forCellReuseIdentifier: "NextCell")
        mTableView.register(UINib(nibName:"NewNextCell" , bundle: Bundle.main), forCellReuseIdentifier: "NewNextCell")
...
//    Tableview Methods
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            let cell = tableView.dequeueReusableCell(withIdentifier: "NextCell") as! NextCell
        ...
        case 1:
            let cell = tableView.dequeueReusableCell(withIdentifier: "NewNextCell") as! NewNextCell
            cell.downloadbutton.addTarget(self, action: #selector(New), for: .touchUpInside)
            cell.alpha = 0
            return cell
    ...
    @objc func New(){
        ...
        UIView.animate(withDuration: 2.0, animations: {
            ...
            self.label3.alpha = 0.0 // Fade out
            //self.label2.transform = CGAffineTransform(scaleX: 1.5, y: 1.5) // Scale up
          
               //   self.label1.center = self.view.center // Move to center
              }) { (completed) in
                  if completed {
                  
                self.label3.alpha = 1 // Fade out
          //      self.label2.transform = CGAffineTransform(scaleX: 1.5, y: 1.5) // Scale up
